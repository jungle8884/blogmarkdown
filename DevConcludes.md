...
<loggers>
    ...
    <logger name="服务名" level="debug" additivity="false">
...
### 在资源文件夹下设置 generator-config.xml 文件
...
### 在 generator-config.xml  文件里设置需要生成的实体类, 就可以自动生成查询条件类
...
![image-20230328233937184](./DevConcludes/image-20230328233937184.png)
